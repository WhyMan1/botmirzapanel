...
جهت پرداخت از دکمه زیر استفاده کنید👇🏻
    ...
    نام کاربری کاربر : @$username";
        ...
        $paymentkeyboard = json_encode([
            'inline_keyboard' => [
                [
                    ['text' => $textbotlang['users']['Balance']['Card'], 'url' => "$pay_address"]
                ]
            ]
        ]);
...
📌 مبلغ $pricetoman  تومان بعد از تایید پرداخت توسط ربات به کیف پول شما اضافه میشود

💢 لطفا به این نکات قبل از پرداخت توجه کنید 👇

🔸 در صورت اشتباه وارد کردن شماره کارت، تراکنش تایید نمیشود و بازگشت وجه امکان پذیر نیست
🔹 مبلغ ارسالی نباید کمتر و یا بیشتر از مبلغ اعلام شده باشد.
🔸 باید دقیقا مبلغی که اعلام شده ارسال شود.
