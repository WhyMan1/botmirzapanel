...
$url = "https://api.github.com/repos/WhyMan1/botmirzapanel/releases/latest";
$curl = curl_init($url);
...
//----------------------move------------------------------//
$sourceDir = '../botmirzapanel-'.$latestRelease['tag_name'];
$source = '../botmirzapanel-'.$latestRelease['tag_name'];
$destinationDir = '../';
